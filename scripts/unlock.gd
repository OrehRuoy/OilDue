...
func _go_unlocked() -> void:
	get_tree().change_scene_to_file(GarageStore.consume_unlock_destination(true))


func _go_back() -> void:
	get_tree().change_scene_to_file(GarageStore.consume_unlock_destination(false))
